...
公开数据集包含 **19,248 条来源提示词**、**34,113 张图片**、**38,484 条翻译**、**224,295 条有效 v2 提示词标签**和 **185 个封闭视觉标签**。打标模型、回填工具、供应商配置、测试批次、错误日志以及其他打标过程记录均不在公开仓库中。以上数字由 `npm run verify:docs` 与 `data/public-corpus.json` 对账。
